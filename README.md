...
- Copy [.env.example](/Users/uyentruongtu/Desktop/Caculator/.env.example) to `.env.local`
...
- Run the SQL in [supabase/migrations/202603190001_initial_app_schema.sql](/Users/uyentruongtu/Desktop/Caculator/supabase/migrations/202603190001_initial_app_schema.sql) in the Supabase SQL Editor before testing saved calculations or the protected dashboard.

## Database

- Apply the SQL in [supabase/migrations/202603190001_initial_app_schema.sql](/Users/uyentruongtu/Desktop/Caculator/supabase/migrations/202603190001_initial_app_schema.sql) to create profiles, calculator runs, saved calculations, newsletter subscribers, and lead forms with baseline RLS policies

## Content Flow

- Calculator SEO copy, related article slugs, and category intros live in [content/manifest.ts](/Users/uyentruongtu/Desktop/Caculator/content/manifest.ts), while calculator examples and explanation sections stay in [content/calculator-pages.ts](/Users/uyentruongtu/Desktop/Caculator/content/calculator-pages.ts).
- Blog articles live locally in [content/articles.ts](/Users/uyentruongtu/Desktop/Caculator/content/articles.ts) and are read through [lib/content.ts](/Users/uyentruongtu/Desktop/Caculator/lib/content.ts).
...
- Use [lib/seo.ts](/Users/uyentruongtu/Desktop/Caculator/lib/seo.ts) for route metadata, canonical URLs, OG fields, WebSite JSON-LD, breadcrumb JSON-LD, and article JSON-LD.
- Crawlable public routes are listed in [app/sitemap.ts](/Users/uyentruongtu/Desktop/Caculator/app/sitemap.ts), while private routes are disallowed in [app/robots.ts](/Users/uyentruongtu/Desktop/Caculator/app/robots.ts).
- Calculator routes are indexable. Auth, dashboard, and saved routes are marked `noindex`.

## Analytics Events

- Route tracking is centralized in [components/analytics/analytics-route-events.tsx](/Users/uyentruongtu/Desktop/Caculator/components/analytics/analytics-route-events.tsx).
- Event helpers live in [lib/analytics/ga.ts](/Users/uyentruongtu/Desktop/Caculator/lib/analytics/ga.ts).
...
- Placeholder slots are configured in [content/monetization.ts](/Users/uyentruongtu/Desktop/Caculator/content/monetization.ts).
- Shared UI lives in [components/marketing/monetization-slot.tsx](/Users/uyentruongtu/Desktop/Caculator/components/marketing/monetization-slot.tsx), [components/marketing/affiliate-resource-card.tsx](/Users/uyentruongtu/Desktop/Caculator/components/marketing/affiliate-resource-card.tsx), and [components/marketing/goldensea-lead-card.tsx](/Users/uyentruongtu/Desktop/Caculator/components/marketing/goldensea-lead-card.tsx).
