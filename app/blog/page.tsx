    ...
    <PageContainer className="space-y-8">
      ...
      <Card className="p-8 md:p-10">
        ...
        <h1 className="page-hero-title mt-4 text-[var(--color-text)]">
          Content sits beside the calculators, not apart from them.
        </h1>
        <p className="page-hero-copy mt-5 text-[var(--color-text-soft)]">
          These articles answer the natural follow-up questions around BMI,
          calories, investing, grades, mortgages, dates, and percentage math
          without turning the hub into a heavy CMS project.
        </p>
      ...
      <section className="space-y-4">
        <SectionHeader
          ...
          description="The MVP keeps content local and explicit, with enough structure to expand later without a CMS migration."
        />
        {allArticles.length > 0 ? (
          ...
          <Card className="border-dashed p-6 text-sm leading-7 text-[var(--color-text-soft)]">
            Articles live in a local content file, so this listing will stay
            lightweight even as the SEO library grows.
          </Card>
        )}
      </section>
      ...
      <section className="space-y-4">
        <SectionHeader
          ...
          description="The blog is designed to support tool intent, so strong internal links back to calculators stay visible on the hub page too."
        />
        <div className="grid gap-4 md:grid-cols-2 xl:grid-cols-3">
